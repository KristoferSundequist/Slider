...
def train(num_actors,episode_size,episodes,beta,ppo_epochs,eps):
    running_reward = 0
    decay = 0.9
    ...
    for i in range(episodes):
        ...
        for _ in range(num_actors):
            ...
            advantage_data.append(discount(rewards,0.99,0))
        ...
        policy.train(acc_states, acc_actionprobs, acc_actions, acc_advantage,beta,ppo_epochs,eps)
